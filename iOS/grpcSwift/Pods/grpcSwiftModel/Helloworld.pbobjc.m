...
#pragma mark - HelloworldRoot_FileDescriptor

static GPBFileDescriptor *HelloworldRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[HelloRequest class]
                                     rootClass:[HelloworldRoot class]
                                          file:HelloworldRoot_FileDescriptor()
                                        fields:fields
